...
def sendApplications():
    dataset = appsCollection.find().sort([("supportStatus", pymongo.DESCENDING), ("isFeatured", pymongo.DESCENDING), ("isCollaboration", pymongo.DESCENDING), ("publishDate", pymongo.DESCENDING) ])
